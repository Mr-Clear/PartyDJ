...
public class FactoryRegistry extends AudioDeviceFactory
{
	...
	public AudioDevice createAudioDevice() throws JavaLayerException
	{
		...
		final AudioDeviceFactory[] factorieList = getFactoriesPriority();
	...
	protected AudioDeviceFactory[] getFactoriesPriority()
	{
		...
		synchronized (factories)
		{
			...
			if (size != 0)
			{
				...
				int idx = 0;
				final Enumeration<AudioDeviceFactory> e = factories.elements();
	...
	{
		addFactory(new SoundAudioDeviceFactory());
	}
}

...
public class PDJSlider extends JPanel
{
	...
	public void setDuration(final double duration)
	{
		...
		middle.setText(de.klierlinge.partydj.common.Functions.formatTime(duration));
		end.setText("-" + de.klierlinge.partydj.common.Functions.formatTime(duration - position));		
	}
	...
	public void setPosition(final double position)
	{
		...
		start.setText(de.klierlinge.partydj.common.Functions.formatTime(position));
		end.setText("-" + de.klierlinge.partydj.common.Functions.formatTime(duration - position));
	}

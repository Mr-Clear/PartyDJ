...
import de.klierlinge.partydj.common.SortMode;
import de.klierlinge.partydj.common.Track;
import de.klierlinge.partydj.common.PlaylistWriter.Format;
import de.klierlinge.partydj.data.SortOrder;
import de.klierlinge.partydj.gui.dnd.DragDropHandler;
import de.klierlinge.partydj.gui.dnd.TrackSelection;
...
class ListMenuItemListener implements ActionListener
{
	...
	public void actionPerformed(final ActionEvent e)
	{
		...
		else if("OpenFile".equals(command))
		{
			...
			fileChooser.setCurrentDirectory(new File(de.klierlinge.partydj.basics.Controller.getInstance().getData().readSetting("PlayListDirectory", de.klierlinge.partydj.common.Functions.getFolder())));
    		...
    		new StatusDialog("Lese M3U", null, new de.klierlinge.partydj.lists.data.InsertM3U(((EditableListModel)list.getListModel()), file.getPath()));
   		}
	...
	protected void save()
	{
		...
		chooser.setCurrentDirectory(new File(Controller.getInstance().getData().readSetting("SavePlaylistDefaultDir", de.klierlinge.partydj.common.Functions.getFolder())));
...
class FileMenuListener implements MenuListener
{
	...
	public void menuSelected(final MenuEvent e)
	{
		...
		final String path = de.klierlinge.partydj.basics.Controller.getInstance().getData().readSetting("PlayListDirectory", de.klierlinge.partydj.common.Functions.getFolder());
...
class FileMenuItemListener implements ActionListener
{
	...
	public void actionPerformed(final ActionEvent e)
	{
		if(list.getListModel() instanceof EditableListModel)
		{
			new StatusDialog("Lese M3U", null, new de.klierlinge.partydj.lists.data.InsertM3U(((EditableListModel)list.getListModel()), e.getActionCommand()));
		}
	}
}

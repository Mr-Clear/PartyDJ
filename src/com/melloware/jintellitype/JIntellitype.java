...
public class JIntellitype implements JIntellitypeConstants {
   ...
   public void registerHotKey(int identifier, int modifier, int keycode) {
     /* if (LOG.isInfoEnabled()) {
         LOG.info("registerHotKey " + Integer.toString(identifier));
      }*/
      try {
   ...
   public void registerHotKey(int identifier, String modifierAndKeyCode) {
     /* if (LOG.isInfoEnabled()) {
         LOG.info("registerHotKey " + modifierAndKeyCode);
      }*/
   ...
   public void unregisterHotKey(int identifier) {
     /* if (LOG.isInfoEnabled()) {
         LOG.info("unregisterHotKey " + Integer.toString(identifier));
      }*/
      try {
   ...
   public static boolean checkInstanceAlreadyRunning(String appTitle) {
    /*  if (LOG.isInfoEnabled()) {
         LOG.info("checkInstanceAlreadyRunning " + appTitle);
      }*/
   ...
   public static boolean isJIntellitypeSupported() {
     ...
     /* if (LOG.isInfoEnabled()) {
         LOG.info("isJIntellitypeSupported = " + result);
      }*/

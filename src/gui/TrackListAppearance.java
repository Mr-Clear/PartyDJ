...
public class TrackListAppearance
{
	 ...
	 */
	public TrackListAppearance(Color nnf, Color nnb, Color nsf, Color nsb,
	                           Color pnf, Color pnb, Color psf, Color psb,
	                           Color rnf, Color rnb, Color rsf, Color rsb,
	                           Font font, Border focusBorder)
	{
	...
	public TrackListAppearance setColor(TrackState trackState, EntryState entryState, Part part, Color color)
	{
		colors[trackState.toInt()][entryState.toInt()][part.toInt()] = color;
		return this;
	}
	
	public Color getColor(TrackState trackState, EntryState entryState, Part part)
	{
		return colors[trackState.toInt()][entryState.toInt()][part.toInt()];
	}
	
	public TrackListAppearance setFont(Font font)
	{
		this.font = font;
		return this;
	}
	...
	public TrackListAppearance setFocusBorder(Border focusBorder)
	{
		this.focusBorder = focusBorder;
		return this;
	}
	...
	public static TrackListAppearance getGreenAppearance(int fontSize)
	{
	...
	public static TrackListAppearance getFormJList(JList list)
	{
